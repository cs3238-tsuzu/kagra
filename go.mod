module github.com/cs3238-tsuzu/kagra
...
replace (
	...
	k8s.io/sample-cli-plugin v0.0.0 => k8s.io/sample-cli-plugin v0.20.2
	k8s.io/sample-controller v0.0.0 => k8s.io/sample-controller v0.20.2
)
